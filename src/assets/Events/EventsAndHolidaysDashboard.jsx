...
const upcomingEvents = eventsList.filter((event) => {
  ...
  //     try {
  //       const res = await axios.get("https://cws-ems-backend.vercel.app/getHolidays");
  ...
  const handleDeleteHoliday = async (id) => {
    ...
    try {
      ...
      await axios.delete(`https://cws-ems-backend.vercel.app/holidays/${id}`, {
  ...
  //         " https://cws-ems-backend.vercel.app/events-for-employee",
  //         { headers: { Authorization: `Bearer ${token}` } }
  //       );
  //       // Sort events by date
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        const token = localStorage.getItem("accessToken");
        const res = await axios.get("https://cws-ems-backend.vercel.app/events-for-employee", {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  const handleDeleteEvent = async (id) => {
    ...
    try {
      const token = localStorage.getItem("accessToken");
      await axios.delete(`https://cws-ems-backend.vercel.app/events/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
