...
function ApplyRegularization({ user, selectedRecord }) {
  ...
  const fetchCounts = async () => {
    try {
      const res = await axios.get(
        `https://cws-ems-backend.vercel.app/attendance/regularization/my/${user._id}`
      );
  ...
  useEffect(() => {
    const fetchWeeklyOffs = async () => {
      try {
        const res = await axios.get(
          `https://cws-ems-backend.vercel.app/admin/weeklyoff/${new Date().getFullYear()}`
        );
...
//bg scroll stop
  ...
  useEffect(() => {
    const fetchAttendance = async () => {
      try {
        const res = await axios.get(`https://cws-ems-backend.vercel.app/attendance/regularization/my/${user._id}`
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const leaveRes = await axios.get(`https://cws-ems-backend.vercel.app/leave/my/${user._id}`);
      ...
      const holidaysRes = await axios.get("https://cws-ems-backend.vercel.app/getHolidays");
