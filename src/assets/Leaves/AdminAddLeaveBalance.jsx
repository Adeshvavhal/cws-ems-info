...
function AdminAddLeaveBalance() {
  ...
  useEffect(() => {
    axios
      .get("https://cws-ems-backend.vercel.app/leaves")
      .then((res) => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://cws-ems-backend.vercel.app/me", {
  ...
  //   try {
  //     await axios.put(`https://cws-ems-backend.vercel.app/leave/${leaveId}/status`, {
  //       status,
  //       userId: user._id,
  //       role: "admin",
  //     });
  ...
  //   try {
  //     const res = await axios.post("https://cws-ems-backend.vercel.app/leave/grant-yearly", {
  //       sl,
  //       cl,
  //     });
  ...
  const fetchYearlySettings = async () => {
    try {
      const res = await axios.get("https://cws-ems-backend.vercel.app/leave/yearly-settings");
      setData(res.data);
    } catch (err) {
  ...
  const grantMonthly = async () => {
    try {
      const res = await axios.post("https://cws-ems-backend.vercel.app/leave/grant-monthly", {
        sl,
        cl,
      });
      setMessage(res.data.message + " for " + res.data.count + " employees");
  ...
  const fetchLeaveBalance = async () => {
    try {
      const res = await axios.get("https://cws-ems-backend.vercel.app/leave/balance");
  ...
  const HandleDelete = async (leaveId) => {
    ...
    try {
      await axios.delete(`https://cws-ems-backend.vercel.app/leave/${leaveId}`);
  ...
  //   try {
  //     const res = await axios.post("https://cws-ems-backend.vercel.app/leave/reset-all");
  ...
  const resetYearlySettings = async () => {
    ...
    try {
      const res = await axios.delete("https://cws-ems-backend.vercel.app/leave/reset-all");
