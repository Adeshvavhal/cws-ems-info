...
//       await axios.delete(`https://cws-ems-backend.vercel.app/soft/deleteEmployee/${id}`, {
...
//       try {
//         const token = localStorage.getItem("accessToken");
//         const res = await axios.get("https://cws-ems-backend.vercel.app/getAllEmployees", {
//           headers: { Authorization: `Bearer ${token}` },
//         });
...
//       const token = localStorage.getItem("accessToken");
//       await axios.put(
//         `https://cws-ems-backend.vercel.app/users/${selectedEmployee._id}/assign-manager`,
