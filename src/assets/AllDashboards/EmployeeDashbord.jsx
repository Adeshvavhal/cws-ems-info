...
const handleCheckOut = async () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://cws-ems-backend.vercel.app/leave/apply", {
        employeeId: user._id,
        ...form,
      });
      alert('submit leave')
    ...
    const fetchData = async () => {
      try {
        const [leaveRes, regRes] = await Promise.all([
          axios.get(`https://cws-ems-backend.vercel.app/leave/my/${user._id}`),
          axios.get(`https://cws-ems-backend.vercel.app/attendance/regularization/my/${user._id}`),
